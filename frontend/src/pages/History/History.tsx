...
import { Download, FileText, Calendar, CheckCircle, XCircle, Clock, RefreshCw, Edit3 } from 'lucide-react';
                            ...
                            <div className="conversion-actions">
                                ...
                                {conversion.status === 'completed' && (
                                    <button
                                        onClick={async () => {
                                            try {
                                                const doc = await apiService.createDocumentFromConversion(conversion.id);
                                                navigate(`/collab/${doc.id}`);
                                            } catch (err) {
                                                console.error('Failed to open editor:', err);
                                                alert('Error al abrir el editor colaborativo.');
                                            }
                                        }}

...
from app.utils.converters.image_converters import (
    ImageToPDFConverter,
    PDFToImageConverter
)
from app.utils.converters.text_converters import (
    TextToDocxConverter,
    DocxToTextConverter,
    PDFToTextConverter
)
from app.utils.converters.pdf_docx_converters import (
    PDFToDocxConverter,
    DocxToPDFConverter
)
from app.utils.converters.xml_html_converters import (
    XMLToHTMLConverter,
    HTMLToXMLConverter
)
...
from app.utils.converters.office_converters import (
    PDFToPptxConverter,
    PptxToPDFConverter,
    PDFToExcelConverter,
    ExcelToPDFConverter
...
def register_all_converters():
    ...
    # Office converters (PDF <-> PowerPoint, PDF <-> Excel)
    registry.register(PDFToPptxConverter())
    registry.register(PptxToPDFConverter())
    registry.register(PDFToExcelConverter())
    registry.register(ExcelToPDFConverter())

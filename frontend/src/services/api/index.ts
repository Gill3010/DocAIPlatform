...
export const apiService = {
    ...
    getChatSessions: ai.getChatSessions,
    getChatSession: ai.getChatSession,
    createChatSession: ai.createChatSession,
    updateChatSession: ai.updateChatSession,
    deleteChatSession: ai.deleteChatSession,
    uploadChatAttachment: ai.uploadChatAttachment,

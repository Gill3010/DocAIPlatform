...
import { LayoutGrid, Tag, Lock, Layers, Heart, Shield } from 'lucide-react';
import { useAppStore } from '../../stores/appStore';
import './MoreMenu.css';

const MORE_ITEMS = [
    { id: 'pricing', label: 'Precios', icon: Tag, href: '/pricing' },
    { id: 'security', label: 'Seguridad', icon: Lock, href: '/security' },
    { id: 'features', label: 'Características', icon: Layers, href: '/features' },
    { id: 'about', label: 'Nosotros', icon: Heart, href: '/about' },
] as const;
                        ...
                        {isAdmin && (
                            <li key="admin" role="none">
                                <Link
                                    ...
                                    onClick={onClose}
                                >
                                    <Shield size={18} className="more-menu__item-icon" />
